...
export default function Register({ setSession, setProfile }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col relative overflow-hidden text-slate-900 selection:bg-cyan-400 selection:text-slate-950">
      ...
      <div className="absolute top-10 left-1/4 w-[450px] h-[450px] bg-cyan-400/20 rounded-full blur-[130px] pointer-events-none" />
      ...
      <div className="flex-1 flex flex-col justify-center py-10 sm:px-6 lg:px-8 z-10">
        <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
          ...
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full glass-card-light text-cyan-800 text-[11px] font-black uppercase tracking-widest mb-3 shadow-sm">
            ...
            Instant Reseller Account
          </div>

          <h2 className="text-3xl font-black text-slate-950 tracking-tight">Create Reseller Account</h2>
        ...
        <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-md px-4">
          <div className="glass-card-light py-8 px-6 shadow-2xl rounded-3xl sm:px-10 border border-cyan-200/80 space-y-4">
            ...
            <div className="pt-2 border-t border-slate-100 text-center">
              <p className="text-[11px] text-slate-500 font-extrabold flex items-center justify-center gap-1.5">
                <ShieldCheck className="w-4 h-4 text-cyan-600" /> Instant Access • 100% Automated Delivery
              </p>
            </div>
