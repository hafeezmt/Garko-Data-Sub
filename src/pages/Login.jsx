...
export default function Login({ setSession, setProfile }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col relative overflow-hidden text-slate-900 selection:bg-emerald-400 selection:text-slate-950">
      ...
      <div className="absolute top-10 right-1/4 w-[500px] h-[500px] bg-emerald-500/15 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-10 left-1/4 w-[500px] h-[500px] bg-teal-500/15 rounded-full blur-[140px] pointer-events-none" />

      <div className="flex-1 flex flex-col justify-center py-12 sm:px-6 lg:px-8 z-10">
        <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
          
          <div className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full glass-card-light text-emerald-900 text-xs font-black uppercase tracking-widest mb-4 shadow-sm">
            <Sparkles className="w-4 h-4 text-amber-500 fill-current animate-pulse" />
            GARKO Reseller Portal
          </div>

          <h2 className="text-3xl font-black text-slate-950 tracking-tight">Login to Your Account</h2>
          <p className="mt-2 text-xs sm:text-sm text-slate-600 font-bold">
            New to GARKO DATA SUB?{' '}
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md px-4">
          <div className="glass-card-light py-8 px-6 shadow-2xl rounded-3xl sm:px-10 border border-emerald-200/80 space-y-6">
            ...
            <div className="pt-4 border-t border-slate-100 text-center">
              <p className="text-xs text-slate-500 font-bold flex items-center justify-center gap-1.5">
                <ShieldCheck className="w-4 h-4 text-emerald-600" /> Protected by Supabase Auth Security
              </p>
            </div>
